...
| `OmniOperatorJIT` | https://gitcode.com/openeuler/OmniOperator.git |
| `OmniStream` | https://gitcode.com/openeuler/OmniStream.git |
| `OmniStateStore` | https://gitcode.com/openeuler/OmniStateStore.git |
| `OmniAdaptor` | https://gitcode.com/openeuler/OmniAdaptor.git |
| `boostkit-bigdata` | https://gitcode.com/boostkit/boostkit-bigdata.git |
| `kacc_json` | https://gitee.com/kunpeng_compute/kacc_json.git |
...
**命令用法：**
```bash
python3 collect_software_info.py <code.xml路径> <WORKSPACE目录> <软件包名>
```
